...
import TrainingsContent from "../content/TrainingsContent";
...
const TITLE_ID = "modal-title-trainings";

export default function TrainingsModal({ title, Icon, zIndex, onFocus, onClose }: TrainingsModalProps) {
